...
module OpenapiClient
  class Class3ChatsApi
    ...
    def add_group_participant_with_http_info(group_participant_action, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(group_participant_action)

      # return_type
      return_type = opts[:debug_return_type] || 'GroupParticipantStatus'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['instanceId', 'token']

      new_options = opts.merge(
        :operation => :"Class3ChatsApi.add_group_participant",
    ...
    def demote_group_participant_with_http_info(group_participant_action, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"Class3ChatsApi.demote_group_participant",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_chats_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Chats'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['instanceId', 'token']

      new_options = opts.merge(
        :operation => :"Class3ChatsApi.get_chats",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def group_with_http_info(create_group_action, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_group_action)

      # return_type
      return_type = opts[:debug_return_type] || 'CreateGroupStatus'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['instanceId', 'token']

      new_options = opts.merge(
        :operation => :"Class3ChatsApi.group",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def promote_group_participant_with_http_info(group_participant_action, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"Class3ChatsApi.promote_group_participant",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def read_chat_with_http_info(read_chat_action, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(read_chat_action)

      # return_type
      return_type = opts[:debug_return_type] || 'ReadChatStatus'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['instanceId', 'token']

      new_options = opts.merge(
        :operation => :"Class3ChatsApi.read_chat",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def remove_group_participant_with_http_info(group_participant_action, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"Class3ChatsApi.remove_group_participant",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
