...
module OpenapiClient
  class Class2MessagesApi
    ...
    def forward_message_with_http_info(forward_message_request, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(forward_message_request)

      # return_type
      return_type = opts[:debug_return_type] || 'SendMessageStatus'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['instanceId', 'token']

      new_options = opts.merge(
        :operation => :"Class2MessagesApi.forward_message",
    ...
    def send_contact_with_http_info(send_contact_request, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(send_contact_request)
      ...
      new_options = opts.merge(
        :operation => :"Class2MessagesApi.send_contact",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def send_file_with_http_info(send_file_request, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(send_file_request)
      ...
      new_options = opts.merge(
        :operation => :"Class2MessagesApi.send_file",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def send_link_with_http_info(send_link_request, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(send_link_request)
      ...
      new_options = opts.merge(
        :operation => :"Class2MessagesApi.send_link",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def send_location_with_http_info(send_location_request, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(send_location_request)
      ...
      new_options = opts.merge(
        :operation => :"Class2MessagesApi.send_location",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def send_message_with_http_info(send_message_request, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"Class2MessagesApi.send_message",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def send_ptt_with_http_info(send_ptt_request, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(send_ptt_request)
      ...
      new_options = opts.merge(
        :operation => :"Class2MessagesApi.send_ptt",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def send_v_card_with_http_info(send_v_card_request, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(send_v_card_request)
      ...
      new_options = opts.merge(
        :operation => :"Class2MessagesApi.send_v_card",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
