...
module OpenapiClient
  class Class7TestingApi
    ...
    def instance_statuses_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Statuses'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['instanceId', 'token']

      new_options = opts.merge(
        :operation => :"Class7TestingApi.instance_statuses",
    ...
    def webhook_statuses_with_http_info(msg_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'WebhookStatus'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['instanceId', 'token']

      new_options = opts.merge(
        :operation => :"Class7TestingApi.webhook_statuses",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
