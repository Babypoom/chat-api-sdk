...
module OpenapiClient
  class Class6BanApi
    ...
    def ban_test_with_http_info(ban_test_action, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(ban_test_action)

      # return_type
      return_type = opts[:debug_return_type] || 'BanTestStatus'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['instanceId', 'token']

      new_options = opts.merge(
        :operation => :"Class6BanApi.ban_test",
    ...
    def get_ban_settings_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'BanSettings'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['instanceId', 'token']

      new_options = opts.merge(
        :operation => :"Class6BanApi.get_ban_settings",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def set_ban_settings_with_http_info(ban_settings, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(ban_settings)
      ...
      new_options = opts.merge(
        :operation => :"Class6BanApi.set_ban_settings",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
