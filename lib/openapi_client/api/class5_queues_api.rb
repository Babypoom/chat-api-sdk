...
module OpenapiClient
  class Class5QueuesApi
    ...
    def clear_actions_queue_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ClearActionsQueueStatus'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['instanceId', 'token']

      new_options = opts.merge(
        :operation => :"Class5QueuesApi.clear_actions_queue",
    ...
    def clear_messages_queue_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ClearMessagesQueueStatus'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['instanceId', 'token']

      new_options = opts.merge(
        :operation => :"Class5QueuesApi.clear_messages_queue",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def show_actions_queue_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'OutboundActions'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['instanceId', 'token']

      new_options = opts.merge(
        :operation => :"Class5QueuesApi.show_actions_queue",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def show_messages_queue_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'OutboundMessages'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['instanceId', 'token']

      new_options = opts.merge(
        :operation => :"Class5QueuesApi.show_messages_queue",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
