  ...
  class Class1InstanceApi
    ...
    def call_retry_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"Class1InstanceApi.call_retry",
    ...
    def expiry_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"Class1InstanceApi.expiry",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_status_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'InstanceStatus'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['instanceId', 'token']

      new_options = opts.merge(
        :operation => :"Class1InstanceApi.get_status",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def logout_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"Class1InstanceApi.logout",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
