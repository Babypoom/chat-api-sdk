...
module OpenapiClient
  class Class4WebhooksApi
    ...
    def set_webhook_with_http_info(webhook_url, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(webhook_url)

      # return_type
      return_type = opts[:debug_return_type] || 'SetWebhookStatus'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['instanceId', 'token']

      new_options = opts.merge(
        :operation => :"Class4WebhooksApi.set_webhook",
